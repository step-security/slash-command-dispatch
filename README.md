...
[![CI](https://github.com/step-security/slash-command-dispatch/workflows/CI/badge.svg)](https://github.com/step-security/slash-command-dispatch/actions?query=workflow%3ACI)
